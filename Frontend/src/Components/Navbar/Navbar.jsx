...
import { CLOUD_SERVICES, CYBER_SECURITY, DIGITAL_MARKETING, NAV_DATA, SIGN_IN, SOFTWARE_DEVELOPMENT, TECHNOLOGY, WEB_DEVELOPMENT } from './NAV_DATA';
                            ...
                            <div>
                                <li className='servicesDropDown'><NavLink to="/services">Service</NavLink>
                                    <ul>
                                        ...
                                        <div className='sub-dropdown'>
                                            <Link to="/technology-training">Technology Training <IoCaretForward /></Link>
                                            <div className="sub-div">
                                                {

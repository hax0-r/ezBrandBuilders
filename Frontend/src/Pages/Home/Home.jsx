...
export default function Home() {
  return (
    <>
      <div className="home">
        <div className="page1">
          <video src={videoXL} muted loop autoPlay />
          <div className="mainPageBG"></div>
          <div className="mainContainer">
            <div className="content">
              <div>

                <h1>Top Ranked, <span>Brand builders in Pakistan</span> </h1>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit aliquid magni voluptatibus et delectus rerum voluptatum officia, reprehenderit numquam animi nam doloremque at impedit quisquam quae odit reiciendis ipsum. Laborum.</p>
                <button>Sign up now
        ...
        <div className="page2">
          ...
          <div className="main">
            ...
            <div className="pg2Container">
              <div className="total">
                {/* <h1>s18.5 B </h1> */}
                <h5><b>EZ Brand Builder leading</b> thousand of bussniess es worldwide since last year</h5>
              </div>
        ...
        <div className="page3">
          <div className="main">
            ...
            <div className="container">
              ...
              <div className="right">
                <h1>E-Commerce <br /> Website</h1>
                <div>
                  <h5>Customize <br />
                    your website</h5>
                  <p>Create a persuasive advertisement copy for a new e-commerce platform, highlighting its unique features, product range, and benefits to potential customers</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="main">
            <div className="container">
              <div className="left">
                ...
                <h4>Transform your mornings with our revolutionary [product/service]. Say goodbye to [pain point] and hello to <span>[benefit]</span></h4>
              </div>
              <div className="right">
                <img src={pg4} alt="" />
              </div>
        ...
        <div className="page11">
          <div className="main">
            <h1>Get a free consultation by registering now.</h1>
